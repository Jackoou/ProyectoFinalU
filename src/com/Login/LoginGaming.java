...
public class LoginGaming extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        imgPanda.setForeground(new java.awt.Color(255, 255, 255));
        ...
        DatosIngreso.setBackground(new java.awt.Color(0, 204, 204));
        ...
        btnRegistrar.setBackground(new java.awt.Color(49, 78, 146));

        txtRegistrar.setFont(new java.awt.Font("Roboto Medium", 1, 18)); // NOI18N
        ...
        btnRegistrarLayout.setHorizontalGroup(
            ...
            .addGroup(btnRegistrarLayout.createSequentialGroup()
                .addComponent(txtRegistrar, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        btnRegistrarLayout.setVerticalGroup(
            btnRegistrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(btnRegistrarLayout.createSequentialGroup()
                .addComponent(txtRegistrar, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );

        O.setBackground(new java.awt.Color(204, 204, 204));
        O.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        O.setForeground(new java.awt.Color(102, 102, 102));
        O.setText("¿O?");
        ...
        DatosIngresoLayout.setHorizontalGroup(
            ...
            .addGroup(DatosIngresoLayout.createSequentialGroup()
                ...
                .addGroup(DatosIngresoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(DatosIngresoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void txtRegistrarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtRegistrarMouseEntered
        btnRegistrar.setBackground(new Color(173,181,227));
        txtRegistrar.setForeground(Color.black);
    ...
    private void txtRegistrarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtRegistrarMouseExited
        btnRegistrar.setBackground(new Color(49,78,146));
